...
<?php
    ...
    //Check if user is laready logged in, if yes redirect to welcome page
                    ...
                    if( mysqli_stmt_num_rows($stmt) == 1 ) {
                        ...
                        if( mysqli_stmt_fetch($stmt) ) {
                            if( password_verify($password, $hashed_password) ) {
                                ...
                                $password_err = 'The password you enter is not valid.';
                            }
                        } 
                    } else {
    ...
    <div class="wrapper">
        <div class="container">
            <div class="row center-col">
                <div class="col-sm-6">
                <h2><em>Login</em></h2>
                    <p class="fill">Please fill in your credentials to login.</p>
